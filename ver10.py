...
- Avoid trading during high news volatility"""
    ...
    def fetch_bitcoin_data(self) -> Optional[float]:
        """Fetch Bitcoin price from multiple sources with enhanced reliability"""
        sources = [
    ...
    def get_binance_data(self) -> Optional[float]:
        ...
        try:
            ...
            logging.warning(f"Binance URL error: {e}")
        except json.JSONDecodeError as e:
            logging.warning(f"Binance JSON decode error: {e}")
        except Exception as e:
            logging.warning(f"Binance unexpected error: {e}")
        return None
