...
class TradingStrategies:
    ...
    def calculate_strategy_signals(self, market_data):
        ...
        if self.is_asian_session():
            if market_data.get('rsi_1h', 50) < 45:
        ...
        if (market_data.get('rsi_1h', 50) < 30 and 
            market_data.get('bollinger_position') == 'lower'):
...
class BitcoinPredictor:
    ...
    def update_advanced_indicators(self):
        ...
        try:
            # Basic indicators
            self.advanced_indicators['rsi_1h'] = self.calculate_rsi(14)
